...
///////////////////////////////////////////////////////////////////////////////
// 9-29 added camera fucntionality and the ability to change proejction.
...
/***********************************************************
 *  Mouse_Scroll_Wheel_Calback()
 *
 *  This method is automatically called from GLFW whenever
 *  the mouse wheel is moved within the active GLFW display window.
 *	taks the input and passes it to the camera class dependacy where it is used to update the camera speed variable.
 ***********************************************************/
...
void ViewManager::ProcessKeyboardEvents()
{
	...
	//if key detected it updates the global variable for the projectio
...
void ViewManager::PrepareSceneView()
{
	...
	//logic to decided what proecjtion to use. false for perepsctive and true for ortho
