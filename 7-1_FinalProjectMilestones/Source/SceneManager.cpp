...
void SceneManager::LoadSceneTextures()
{
	...
	// added the different images for shading
	bReturn = CreateGLTexture(
		"C:/Users/nicho/OneDrive/Desktop/CS330Content/CS330Content/Utilities/textures/knife_handle.jpg",
		"floor");

	bReturn = CreateGLTexture(
		"C:/Users/nicho/OneDrive/Desktop/CS330Content/CS330Content/Utilities/textures/dirt.jpg",
		"dirt");

	bReturn = CreateGLTexture(
		"C:/Users/nicho/OneDrive/Desktop/CS330Content/CS330Content/Utilities/textures/stone.jpg",
		"stone");

	bReturn = CreateGLTexture(
		"C:/Users/nicho/OneDrive/Desktop/CS330Content/CS330Content/Utilities/textures/rockwall.jpg",
		"wall");

	bReturn = CreateGLTexture(
		"C:/Users/nicho/OneDrive/Desktop/CS330Content/CS330Content/Utilities/textures/Bark.jpg",
		"Bark");

	bReturn = CreateGLTexture(
		"C:/Users/nicho/OneDrive/Desktop/CS330Content/CS330Content/Utilities/textures/backdrop.jpg",
		"backdrop");

	bReturn = CreateGLTexture(
		"C:/Users/nicho/OneDrive/Desktop/CS330Content/CS330Content/Utilities/textures/Stainless.jpg",
		"stainless");

	bReturn = CreateGLTexture(
		"C:/Users/nicho/OneDrive/Desktop/CS330Content/CS330Content/Utilities/textures/gold-seamless-texture.jpg",
		"hilt");
...
void SceneManager::SetupSceneLights()
{
	...
	m_pShaderManager->setVec3Value("lightSources[3].position", 1.0f, 10.0f, -5.0f);
...
void SceneManager::RenderScene()
{
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(20.0, 1.0f, 10.0f);
	...
	/******************************************************************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(40.f, 4.0f, 1.0f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 2.0f, -2.0);
	...
	/***************************************************************************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(1.3f, 40.0f, 1.3f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(-9.0f, 2.0f, -4.0);
	...
	/***************************************************************************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.4f, 40.0f, 0.4f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(14.0f, 2.0f, -4.0);
	...
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.5, 2.5f, 2.5f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.6f, 6.0f, 0.1f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 3.0f, 5.0);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(2.4f, 0.2f, 0.28f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 6.0f, 5.0);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.14f, 1.8f, 0.14f);
	...
	/******************************************************************/
	// set the XYZ scale for the mesh
	scaleXYZ = glm::vec3(0.24f, 0.3f, 0.24f);
	...
	// set the XYZ position for the mesh
	positionXYZ = glm::vec3(0.0f, 8.0f, 4.85);
